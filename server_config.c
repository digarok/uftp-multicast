 ...
 *
 *  Copyright (C) 2001-2018   Dennis A. Bush, Jr.   bush@tcnj.edu
 *
...
static int get_keytype(const char *name)
{
    if (!strcmp(name, "none")) {
        return KEY_NONE;
    } else if (!strcmp(name, "des")) {
        return KEY_DES;
    } else if (!strcmp(name, "3des")) {
        return KEY_DES_EDE3;
    } else if (!strcmp(name, "aes128-cbc")) {
        return KEY_AES128_CBC;
    } else if (!strcmp(name, "aes256-cbc")) {
        return KEY_AES256_CBC;
    } else if (!strcmp(name, "aes128-gcm")) {
        return KEY_AES128_GCM;
    } else if (!strcmp(name, "aes256-gcm")) {
        return KEY_AES256_GCM;
    } else if (!strcmp(name, "aes128-ccm")) {
        return KEY_AES128_CCM;
    } else if (!strcmp(name, "aes256-ccm")) {
